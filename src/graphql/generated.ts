...
export type GetLessonSlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', description?: string | null, title: string, videoId: string, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };
