      ...
      <div className="bg-black flex justify-center">
        ...
        <div className="p-8 max-w[1100px] mx-auto">
            ...
            <div className="flex-1">
              ...
              {data.lesson.teacher && (
                <div className="flex itens-center gap-4 mt-6">
                 ...
                 src={data.lesson.teacher.avatarURL}alt="foto de perfil do professor" />

                  <div className="leading-relaxed">
                    <strong className="font-bold text-2xl block">{data.lesson.teacher.name}
                    </strong>
                    <span className="text-gray-200 text-sm block">{data.lesson.teacher.bio}
                    </span>
                  </div>
                </div>
              )}
          ...
          <div className="gap-8 mt-20 grid grid-cols-2">
            <a href="Botão de material complementar" 
...
function useGetLessonBySlugQuery(arg0: { variables: { slug: string; }; }): { data: any; } {
